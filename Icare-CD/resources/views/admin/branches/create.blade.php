<x-admin-layout>
    <x-slot:title>Create Branch</x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Create Branch</h1>
                    <p class="mt-1 text-sm text-gray-600">Add a new branch location for offline student management</p>
                </div>
            </div>
        </div>
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Letters only, max 10 chars</p>
                            @error('code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="address"
                                      ...
                                      class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 @error('address') border-red-300 @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <label class="flex items-center mt-2">
                                <input type="checkbox"
                                       ...
                                       value="1"
                                       {{ old('allow_test_retakes') ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
