...
<x-dashboard-layout>
    ...
    <div x-data="{ showAll: false, testsPerPage: 9, loading: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            @php
                $totalTestsTaken = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 1); })->count();
                $avgScore = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 1); })->where('status', 'completed')->avg('band_score');
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">Improve your listening skills with real IELTS format tests</p>
                            </div>
                        </div>
                            ...
                            <div class="p-5">
                                ...
                                @if($inProgressAttempt)
                                    <div class="flex gap-2">
                                        <a href="{{ route('student.listening.start', $testSet) }}"
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                    <div class="max-w-md mx-auto">
                        <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-6">
                            <i class="fas fa-headphones-alt text-gray-400 text-3xl"></i>
                        </div>
