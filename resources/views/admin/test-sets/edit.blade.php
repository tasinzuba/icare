                    ...
                    <form action="{{ route('admin.test-sets.update', $testSet) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <!-- For Online Students -->
                                <div class="rounded-lg border-2 p-4 transition-colors {{ old('is_for_online', $testSet->is_for_online) ? 'border-emerald-400 bg-emerald-50' : 'border-gray-200 hover:border-emerald-300' }}" id="online-checkbox-container">
                                    <label class="flex items-start cursor-pointer">
                                        <div class="flex h-5 items-center">
                                            <input type="checkbox"
                                                   id="is_for_online"
                                                   name="is_for_online"
                                                   value="1"
                                                   {{ old('is_for_online', $testSet->is_for_online) ? 'checked' : '' }}
