...
<x-dashboard-layout>
    ...
    <div x-data="{ showAll: false, testsPerPage: 9, loading: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            @php
                $totalTestsTaken = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 4); })->count();
                $avgScore = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 4); })->where('status', 'completed')->avg('band_score');
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">Build confidence with AI-powered speaking practice sessions</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-6 bg-gray-50 rounded-2xl p-5 border border-gray-200">
                            ...
                            <div class="w-px h-12 bg-gray-200"></div>
                            <div class="text-center">
                                <p class="text-2xl font-bold text-gray-900">15m</p>
                            ...
                            <div class="p-5">
                                ...
                                @if($inProgressAttempt)
                                    <div class="flex gap-2">
                                        <a href="{{ route('student.speaking.start', $testSet) }}"
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                    <div class="max-w-md mx-auto">
                        <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-6">
                            <i class="fas fa-comment-dots text-gray-400 text-3xl"></i>
                        </div>
