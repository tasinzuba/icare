...
<x-dashboard-layout>
    ...
    <div x-data="{ showAll: false, testsPerPage: 9, loading: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            @php
                $totalTestsTaken = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 3); })->count();
                $avgScore = auth()->user()->attempts()->whereHas('testSet', function($q) { $q->where('section_id', 3); })->where('status', 'completed')->avg('band_score');
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">Develop your writing skills with Task 1 and Task 2 essays</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-6 bg-gray-50 rounded-2xl p-5 border border-gray-200">
                            ...
                            <div class="w-px h-12 bg-gray-200"></div>
                            <div class="text-center">
                                <p class="text-2xl font-bold text-gray-900">20-60m</p>
                            ...
                            <div class="p-5">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if($testSet->writing_task_type === 'task1')
                                                    <span class="flex-shrink-0 px-2 py-0.5 text-xs font-semibold rounded-full bg-blue-100 text-blue-700">Task 1</span>
                                                @elseif($testSet->writing_task_type === 'task2')
                                                    <span class="flex-shrink-0 px-2 py-0.5 text-xs font-semibold rounded-full bg-purple-100 text-purple-700">Task 2</span>
                                                @endif
                                            </div>
                                ...
                                <div class="flex items-center gap-4 text-sm text-gray-500 mb-4">
                                    <span class="flex items-center gap-1">
                                        ...
                                        {{ $testSet->getEffectiveTimeLimitMinutes() }} min
                                    </span>
                                    <span class="flex items-center gap-1">
                                        <i class="fas fa-tasks text-gray-400"></i>
                                        @if($testSet->writing_task_type)
                                            Task {{ $testSet->getWritingTaskNumber() }}
                                        @else
                                            2 tasks
                                        @endif
                                    </span>
                                ...
                                @if($inProgressAttempt)
                                    <div class="flex gap-2">
                                        <a href="{{ route('student.writing.start', $testSet) }}"
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                    <div class="max-w-md mx-auto">
                        <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-6">
                            <i class="fas fa-pen-nib text-gray-400 text-3xl"></i>
                        </div>
