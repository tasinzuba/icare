<x-dashboard-layout>
    <x-slot name="title">Task 2 Practice Questions</x-slot>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Task 2 Practice Questions</h1>
        ...
        @if($questions->isEmpty())
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <p class="text-gray-600">Task 2 practice questions will appear here when available</p>
            </div>
        @else
